...
#intersphinx to ecto. e.g. :ref:`Ecto <ecto:overview-ecto>`
intersphinx_mapping = {'ecto':('http://ecto.willowgarage.com/releases/bleedingedge',None)
                       }
...
html_title = 'ecto opencv ' + gittag_short
