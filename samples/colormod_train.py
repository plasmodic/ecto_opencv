...
#testimage = line_mod.TestColorImage(filename="test_tree.txt",template_size=cv.Size(45,120),
#                                   sample_skipx=5,sample_skipy=5,
#                                   match_thresh=0.95,search_skipx=5,search_skipy=5,hist_type=1,overlap_thresh=.5)
...
mask_display = highgui.imshow("mask display", name="mask", waitKey=0, autoSize=True)
